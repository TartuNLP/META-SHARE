...
def confirm(request, uuid):
    ...
    try:
        ...
        email, 'metashare@metashare.ut.ee', [user.email], fail_silently=False)
        ...
        if form.is_valid():
            ...
            try:
                send_mail(_('[META-SHARE] Contact Form Request: %s')
                    ...
                    'metashare@metashare.ut.ee', superuser_emails,
                    fail_silently=False)
            except:
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                email, 'metashare@metashare.ut.ee', [_user.email],
                fail_silently=False)
            except: #SMTPException:
                # If the email could not be sent successfully, tell the user
            ...
            if EditorGroupApplication.objects.filter(
                ...
                try:
                    ...
                    send_mail('New editor membership request',
                        ...
                        'metashare@metashare.ut.ee', emails, fail_silently=False)
                except: #SMTPException:
                    # If the email could not be sent successfully, tell the user
                    # about it.
                    messages.error(request,
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    email, 'metashare@metashare.ut.ee', [user.email],
                    fail_silently=False)
